			...
			<div class="row col-md-12">
				<div class="col-md-12">
					...
					<form class="form-horizontal" name="add_artical_form"
						action="<%=basePath %>article.html?action=saveupdate&artId=${art.id}&adminId=${sessionScope.admin.getId()}"
						method="post">
						<div class="col-md-6">
							<div class="form-group">
								<label for="title">标题</label> <input class="form-control"
									id="name" name="title" type="text" value="${art.title }">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<textarea class="form-control" id="message" name="summary"
									placeholder="摘要" rows="5">${art.getSummary() }</textarea>
							</div>

							<div class="form-group">
								<textarea class="form-control" id="message" name="content"
									placeholder="文章内容" rows="5">${art.getContent() }</textarea>
							</div>
